...
[GlobalClass]
public partial class MotionModule : Node {
    ...
    */
    ...
    public MotionModule(CharacterBody3D body){
        this.body = body;
    }

    public override void _Ready(){
        base._Ready();
        if (body == null && HasNode("CharacterBody3D")) {
            body = GetNode<CharacterBody3D>("CharacterBody3D");
        }
        if (body == null){
            GD.PushWarning("MotionModule: No CharacterBody3D found");
        }
    }
    ...
    public void Update(double dt){
        ...
        float deceleration_distance = 2.0f; // Adjust this value as needed
